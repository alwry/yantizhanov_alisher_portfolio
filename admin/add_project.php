...
$newname = 'img'.$random; // will store something like 'image49814'


// PHP can get the original file extension (without the '.'). It also makes sure the extension is lowercase, so 'JPG' becomes 'jpg'.

$filetype = strtolower(pathinfo($_FILES['thumb']['name'], PATHINFO_EXTENSION));
...
if(move_uploaded_file($_FILES['thumb']['tmp_name'], $target_file)) {  //moves the tmp file to its final location, with its new name, before it is automatically deleted


// PDO database insert

$query = "INSERT INTO projects (title,heading_1,heading_2,heading_3,heading_4,description_1,description_2,description_3,description_4,thumb,date,tags) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $connect->prepare($query);
$stmt->bindParam(1, $_POST['title'], PDO::PARAM_STR);
$stmt->bindParam(2, $_POST['heading_1'], PDO::PARAM_STR);
$stmt->bindParam(3, $_POST['heading_2'], PDO::PARAM_STR);
$stmt->bindParam(4, $_POST['heading_3'], PDO::PARAM_STR);
$stmt->bindParam(5, $_POST['heading_4'], PDO::PARAM_STR);
$stmt->bindParam(6, $_POST['description_1'], PDO::PARAM_STR);
$stmt->bindParam(7, $_POST['description_2'], PDO::PARAM_STR);
$stmt->bindParam(8, $_POST['description_3'], PDO::PARAM_STR);
$stmt->bindParam(9, $_POST['description_4'], PDO::PARAM_STR);
$stmt->bindParam(10, $newname, PDO::PARAM_STR);
$stmt->bindParam(11, $_POST['date'], PDO::PARAM_STR);
$stmt->bindParam(12, $_POST['tags'], PDO::PARAM_STR);
