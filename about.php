...
<body>
  ...
  <main>
    <section class="about">
      <div class="grid-con">
        <h2 class="page-h2 col-span-3 t-col-span-4 l-col-span-6">About me</h2>
      </div>
    </section>
    ...
    <section class="chapter-one">
      <div class="grid-con">
        <!-- Chapter 1 -->
        <div class="col-span-full about-chapter">
          <div class="chapter-div">
            <p>Chapter-1</p>
            <h3 class="decorative-h">Who I Am</h3>
          </div>
          <div class="chapter-div">
            <p class="decorative-p">[01]</p>
            <p class="main-p">Hailing from Kazakhstan and currently based in Canada, I'm a versatile designer passionate about crafting exceptional user interfaces and innovative product designs.</p>
            <p class="main-p">Dive into my portfolio to explore my expertise in UI/UX and product design, where I merge creativity with functionality to bring ideas to life.</p>
          </div>
        </div>
        ...
        <div class="col-span-full about-chapter">
          <div class="chapter-div">
            <p>Chapter-2</p>
            <h3 class="decorative-h">Education</h3>
          </div>
          <div class="chapter-div">
            <p class="decorative-p">[02]</p>
            <p class="main-p">Having completed a comprehensive 2.5-year graphic design program at Step IT Academy, encompassing graphic design, UI/UX, interior design, brand identity, and motion design, I'm currently honing my skills further as an Interactive Media Design student at Fanshawe College.</p>
          </div>
        </div>
        ...
        <div class="col-span-full about-chapter">
          <div class="chapter-div">
            <p>Chapter-3</p>
            <h3 class="decorative-h">Experience</h3>
          </div>
          <div class="chapter-div">
            <p class="decorative-p">[03]</p>
            
            <div class="experience">
              <p class="descriptor">apr. 2021 – aug. 2023</p>
              <h3 class="chapter-h3">Diyanet</h3>
              <p class="main-p">An interior design company where I was a lead graphic designer. My main responsibilities were social media design and web design.</p>
            </div>

            <div class="experience">
              <p class="descriptor">may. 2021 – present</p>
              <h3 class="chapter-h3">Freelance</h3>
              <p class="main-p">Freelance is a great way to practice and gain new skills, especially in design. It also taught me social skills that each designer needs as an oxygen.</p>
            </div>

            <div class="experience">
              <p class="descriptor">jul. 2022 – aug. 2023</p>
              <h3 class="chapter-h3">CandyToys</h3>
              <p class="main-p">Kids toys retail company located in Almaty. Packaging design, social media design and digital marketing done by me helped e-commerce sector to grow by 80%.</p>
            </div>
          </div>
        </div>
      </div>
